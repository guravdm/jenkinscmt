...
@Entity(name = "maintask_email_log")
@Table(name = "maintask_email_log")
public class MainTaskEmailLog {
	...
	public String toString() {
		return "MainTaskEmailLog [log_id=" + log_id + ", client_task_id=" + client_task_id + ", email_subject="
				+ email_subject + ", email_to=" + email_to + ", created_at=" + created_at
				+ ", entity_name=" + entity_name + ", unit_name=" + unit_name + ", function_name=" + function_name
				+ ", name_of_legislation=" + name_of_legislation + ", name_of_rule=" + name_of_rule + ", log_when="
				+ log_when + ", activity=" + activity + ", frequency=" + frequency + ", impact=" + impact
				+ ", executor_date=" + executor_date + ", evaluator_date=" + evaluator_date + ", func_head_date="
				+ func_head_date + ", unit_head_date=" + unit_head_date + ", legal_due_date=" + legal_due_date
				+ ", exec_id=" + exec_id + ", eval_id=" + eval_id + ", fh_id=" + fh_id + ", email_status="
				+ email_status + ", email_sent_at=" + email_sent_at + "]";
	}
