...
function() {
    ...
    angular.module("ui.grid").constant("uiGridConstants", {
        ...
        CURRENCY_SYMBOLS: ["Æ’", "$", "Â£", "$", "Â¤", "Â¥", "áŸ›", "â‚©", "â‚±", "à¸¿", "â‚«"],
        scrollDirection: {
            UP: "up",
            DOWN: "down",
            LEFT: "left",
            ...
            var e = {
                ...
                link: function(b, e, f, g) {
                    ...
                    d.initialize(b, g), b.defaultMenuItems = d.getDefaultMenuItems(b), b.menuItems = b.defaultMenuItems, d.setColMenuItemWatch(b), b.showMenu = function(a, c, f) {
                        ...
                        b.menuShown ? (b.colElement = c, b.colElementPosition = g, b.hideThenShow = !0, b.$broadcast("hide-menu", {
                            originalEvent: f
                        })) : (h.shown = b.menuShown = !0, d.repositionMenu(b, a, g, e, c), b.colElement = c, b.colElementPosition = g, b.$broadcast("show-menu", {
                            originalEvent: f
                        }))
                        ...
                        b.col.colDef.visible = !1, b.col.visible = !1, b.grid.queueGridRefresh(), b.hideMenu(), b.grid.api.core.notifyDataChange(c.dataChange.COLUMN), b.grid.api.core.raise.columnVisibilityChanged(b.col)
                    }
                },
    ...
    function() {
        "use strict";
        angular.module("ui.grid").directive("uiGridFilter", ["$compile", "$templateCache", function(a, b) {
            return {
                compile: function() {
                    return {
    ...
    function() {
        "use strict";
        angular.module("ui.grid").directive("uiGridHeaderCell", ["$compile", "$timeout", "$window", "$document", "gridUtil", "uiGridConstants", "ScrollEvent", function(a, b, c, d, e, f, g) {
            var h = 500,
                i = 500,
                j = {
                    priority: 0,
                    ...
                    compile: function() {
                        return {
                            ...
                            post: function(a, c, e, g) {
                                ...
                                var m, n, o = (angular.element(c[0].querySelectorAll(".ui-grid-header-cell-menu")), angular.element(c[0].querySelectorAll(".ui-grid-cell-contents"))),
                                    p = [];
                                a.downFn = function(e) {
                                    e.stopPropagation(), "undefined" != typeof e.originalEvent && void 0 !== e.originalEvent && (e = e.originalEvent), e.button && 0 !== e.button || (n = e.pageX, a.mousedownStartTime = (new Date).getTime(), a.mousedownTimeout = b(function() {}, h), a.mousedownTimeout.then(function() {
                                        a.colMenu && j.columnMenuScope.showMenu(a.col, c, e)
                                    ...
                                    e > h || a.sortable && a.handleClick(c)
                                }, a.moveFn = function(c) {
                                    var d = c.pageX - n;
                                    ...
                                    o.off("touchstart", a.downFn), o.off("mousedown", a.downFn), d.off("touchend", a.upFn), d.off("mouseup", a.upFn), d.off("touchmove", a.moveFn), d.off("mousemove", a.moveFn), o.off("click", a.clickFn)
                                }, a.onDownEvents = function(c) {
                                    switch (c) {
                                        case "touchmove":
                                        case "touchend":
                                            o.on("click", a.clickFn), o.on("touchstart", a.downFn), b(function() {
                                                o.on("mousedown", a.downFn)
                                            }, i);
                                            break;
                                        case "mousemove":
                                        case "mouseup":
                                            o.on("click", a.clickFn), o.on("mousedown", a.downFn), b(function() {
                                                o.on("touchstart", a.downFn)
                                            }, i);
                                            break;
                                        default:
                                            o.on("click", a.clickFn), o.on("touchstart", a.downFn), o.on("mousedown", a.downFn)
                                    }
                                };
                                var q = function(b) {
                                    var d = c;
                                    m && (d.removeClass(m), m = null), m = angular.isFunction(a.col.headerCellClass) ? a.col.headerCellClass(a.grid, a.row, a.col, a.rowRenderIndex, a.colRenderIndex) : a.col.headerCellClass, d.addClass(m);
                                    var e = a.grid.renderContainers.right ? a.grid.renderContainers.right : a.grid.renderContainers.body;
                                    a.isLastCol = a.col === e.visibleColumnCache[e.visibleColumnCache.length - 1], j.grid.options.enableSorting && a.col.enableSorting ? a.sortable = !0 : a.sortable = !1;
                                    var g = a.filterable;
                                    j.grid.options.enableFiltering && a.col.enableFiltering ? a.filterable = !0 : a.filterable = !1, g !== a.filterable && ("undefined" != typeof a.col.updateFilters && a.col.updateFilters(a.filterable), a.filterable ? (a.col.filters.forEach(function(b, c) {
                                        p.push(a.$watch("col.filters[" + c + "].term", function(a, b) {
                                            a !== b && (j.grid.api.core.raise.filterChanged(), j.grid.api.core.notifyDataChange(f.dataChange.COLUMN), j.grid.queueGridRefresh())
                                        }))
                                ...
                                q();
                                var r = a.grid.registerDataChangeCallback(q, [f.dataChange.COLUMN]);
                                a.$on("$destroy", r), a.handleClick = function(b) {
                                    var c = !1;
        ...
        angular.module("ui.grid").directive("uiGridMenu", ["$compile", "$timeout", "$window", "$document", "gridUtil", "uiGridConstants", function(a, b, c, d, e, f) {
            var g = {
                ...
                link: function(a, d, e, g) {
                    ...
                    }, h.hideMenu = a.hideMenu = function(c, d) {
                    ...
                    }), g && a.$on("$destroy", g.grid.api.core.on.scrollBegin(a, i)), a.$on("$destroy", a.$on(f.events.ITEM_DRAGGING, i))
                },
                        ...
                        post: function(a, b, d, e) {
                            ...
                            ("undefined" == typeof a.shown || null === a.shown) && (a.shown = function() {
                                ...
                                if (b.stopPropagation(), "function" == typeof a.action) {
                                    var d = {};
                                    a.context && (d.context = a.context), "undefined" != typeof f && f && (d.grid = f.grid), a.action.call(d, b, c), a.leaveOpen || a.$emit("hide-menu")
                                }
                            }, a.i18n = c.get()
                        }
                    }
        ...
        angular.module("ui.grid").factory("GridColumn", ["gridUtil", "uiGridConstants", "i18nService", function(a, b, c) {
            ...
            return d.prototype.setPropertyOrDefault = function(a, b, c) {
                ...
                b.filter ? j.push(b.filter) : b.filters ? j = b.filters : j.push({}), c ? (e.setPropertyOrDefault(b, "filter"), e.setPropertyOrDefault(b, "filters", j)) : e.filters.length === j.length && e.filters.forEach(function(a, b) {
                    "undefined" != typeof j[b].placeholder && (a.placeholder = j[b].placeholder), "undefined" != typeof j[b].flags && (a.flags = j[b].flags), "undefined" != typeof j[b].type && (a.type = j[b].type), "undefined" != typeof j[b].selectOptions && (a.selectOptions = j[b].selectOptions)
        ...
        f.service("gridUtil", ["$log", "$window", "$document", "$http", "$templateCache", "$timeout", "$interval", "$injector", "$q", "$interpolate", "uiGridConstants", function(f, g, l, m, n, o, p, q, r, s, t) {
            ...
            var x = {
                ...
                disableAnimations: function(a) {
                    var b;
                    try {
                        b = q.get("$animate"), b.enabled(!1, a)
                    } catch (c) {}
                },
                enableAnimations: function(a) {
                    var b;
                    try {
                        return b = q.get("$animate"), b.enabled(!0, a), b
                    } catch (c) {}
                },
                nextUid: function() {
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                var b = {
                    ...
                    groupPanel: {
                        description: "PÅ™esuntÄ› zÃ¡hlavÃ­ zde pro vytvoÅ™enÃ­ skupiny dle sloupce."
                    },
                    search: {
                        placeholder: "Hledat...",
                        showingItems: "Zobrazuji poloÅ¾ky:",
                        selectedItems: "VybranÃ© poloÅ¾ky:",
                        totalItems: "Celkem poloÅ¾ek:",
                        size: "Velikost strany:",
                        first: "PrvnÃ­ strana",
                        next: "DalÅ¡Ã­ strana",
                        previous: "PÅ™edchozÃ­ strana",
                        last: "PoslednÃ­ strana"
                    },
                    menu: {
                        text: "Vyberte sloupec:"
                    },
                    sort: {
                        ascending: "SeÅ™adit od A-Z",
                        descending: "SeÅ™adit od Z-A",
                        remove: "Odebrat seÅ™azenÃ­"
                    },
                    column: {
                        hide: "Schovat sloupec"
                    },
                    aggregation: {
                        count: "celkem Å™Ã¡dkÅ¯: ",
                        sum: "celkem: ",
                        avg: "avg: ",
                        min: "min.: ",
                        max: "max.: "
                    ...
                    gridMenu: {
                        ...
                        exporterAllAsCsv: "Exportovat vÅ¡echny data do csv",
                        exporterVisibleAsCsv: "Exportovat viditelnÃ© data do csv",
                        exporterSelectedAsCsv: "Exportovat vybrannÃ© data do csv"
                    },
                    importer: {
                        noHeaders: "NÃ¡zvy sloupcÅ¯ se nepodaÅ™ilo zÃ­skat, obsahuje soubor zÃ¡hlavÃ­?",
                        noObjects: "Data se nepodaÅ™ilo zpracovat, obsahuje soubor Å™Ã¡dky mimo zÃ¡hlavÃ­?",
                        invalidCsv: "Soubor nelze zpracovat, jednÃ¡ se CSV?",
                        invalidJson: "Soubor nelze zpracovat, je to JSON?",
                        jsonNotArray: "Soubor musÃ­ obsahovat json. UkonÄ�uji.."
                    },
                    pagination: {
                        sizes: "poloÅ¾ek na strÃ¡nku",
                        totalItems: "poloÅ¾ek"
                    },
                    grouping: {
                        group: "Seskupit",
                        ungroup: "Odebrat seskupenÃ­",
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("da", {
                    ...
                    groupPanel: {
                        description: "GrupÃ©r rÃ¦kker udfra en kolonne ved at trÃ¦kke dens overskift hertil."
                    },
                    search: {
                        placeholder: "SÃ¸g...",
                        showingItems: "Viste rÃ¦kker:",
                        selectedItems: "Valgte rÃ¦kker:",
                        totalItems: "RÃ¦kker totalt:",
                        size: "Side stÃ¸rrelse:",
                        first: "FÃ¸rste side",
                        next: "NÃ¦ste side",
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("de", {
                    ...
                    groupPanel: {
                        description: "Ziehen Sie eine SpaltenÃ¼berschrift hierhin, um nach dieser Spalte zu gruppieren."
                    },
                    search: {
                        placeholder: "Suche...",
                        showingItems: "Zeige EintrÃ¤ge:",
                        selectedItems: "AusgewÃ¤hlte EintrÃ¤ge:",
                        totalItems: "EintrÃ¤ge gesamt:",
                        size: "EintrÃ¤ge pro Seite:",
                        first: "Erste Seite",
                        next: "NÃ¤chste Seite",
                    ...
                    menu: {
                        text: "Spalten auswÃ¤hlen:"
                    },
                    sort: {
                        ascending: "aufsteigend sortieren",
                        descending: "absteigend sortieren",
                        remove: "Sortierung zurÃ¼cksetzen"
                    },
                    column: {
                    ...
                    importer: {
                        ...
                        noObjects: "Es konnten keine Zeileninformationen gelesen werden, Sind in der Datei auÃŸer den Spaltendefinitionen auch Daten enthalten?",
                        invalidCsv: "Die Datei konnte nicht eingelesen werden, ist es eine gÃ¼ltige CSV-Datei?",
                        invalidJson: "Die Datei konnte nicht eingelesen werden. EnthÃ¤lt sie gÃ¼ltiges JSON?",
                        jsonNotArray: "Die importierte JSON-Datei muÃŸ ein Array enthalten. Breche Import ab."
                    },
                    pagination: {
                        sizes: "EintrÃ¤ge pro Seite",
                        totalItems: "EintrÃ¤ge"
                    },
                    grouping: {
                        group: "Gruppieren",
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("es", {
                    ...
                    groupPanel: {
                        description: "Arrastre un encabezado de columna aquÃ­ y suÃ©ltelo para agrupar por esa columna."
                    },
                    search: {
                        placeholder: "Buscar...",
                        showingItems: "ArtÃ­culos Mostrados:",
                        selectedItems: "ArtÃ­culos Seleccionados:",
                    ...
                    gridMenu: {
                        ...
                        exporterSelectedAsCsv: "Exportar selecciÃ³n como csv"
                    },
                    importer: {
                        noHeaders: "No fue posible derivar los nombres de las columnas, Â¿tiene encabezados el archivo?",
                        noObjects: "No fue posible obtener registros, Â¿contiene datos el archivo, aparte de los encabezados?",
                        invalidCsv: "No fue posible procesar el archivo, Â¿es un CSV vÃ¡lido?",
                        invalidJson: "No fue posible procesar el archivo, Â¿es un Json vÃ¡lido?",
                        jsonNotArray: "El archivo json importado debe contener un array, abortando."
                    },
                    pagination: {
                        sizes: "registros por pÃ¡gina",
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("fa", {
                    ...
                    groupPanel: {
                        description: "Ø¹Ù†ÙˆØ§Ù† ÛŒÚ© Ø³ØªÙˆÙ† Ø±Ø§ Ø¨Ú¯ÛŒØ± Ùˆ Ø¨Ù‡ Ú¯Ø±ÙˆÙ‡ÛŒ Ø§Ø² Ø¢Ù† Ø³ØªÙˆÙ† Ø±Ù‡Ø§ Ú©Ù†."
                    },
                    search: {
                        placeholder: "Ø¬Ø³ØªØ¬Ùˆ...",
                        showingItems: "Ù†Ù…Ø§ÛŒØ´ Ø§Ù‚Ù„Ø§Ù…:",
                        selectedItems: "Ù‚Ù„Ù…â€ŒÙ‡Ø§ÛŒ Ø§Ù†ØªØ®Ø§Ø¨ Ø´Ø¯Ù‡:",
                        totalItems: "Ù…Ø¬Ù…ÙˆØ¹ Ø§Ù‚Ù„Ø§Ù…:",
                        size: "Ø§Ù†Ø¯Ø§Ø²Ù‡â€ŒÛŒ ØµÙ�Ø­Ù‡:",
                        first: "Ø§ÙˆÙ„ÛŒÙ† ØµÙ�Ø­Ù‡",
                        next: "ØµÙ�Ø­Ù‡â€ŒÛŒâ€ŒØ¨Ø¹Ø¯ÛŒ",
                        previous: "ØµÙ�Ø­Ù‡â€ŒÛŒâ€Œ Ù‚Ø¨Ù„ÛŒ",
                        last: "Ø¢Ø®Ø±ÛŒÙ† ØµÙ�Ø­Ù‡"
                    },
                    menu: {
                        text: "Ø³ØªÙˆÙ†â€ŒÙ‡Ø§ÛŒ Ø§Ù†ØªØ®Ø§Ø¨ÛŒ:"
                    },
                    sort: {
                        ascending: "ØªØ±ØªÛŒØ¨ ØµØ¹ÙˆØ¯ÛŒ",
                        descending: "ØªØ±ØªÛŒØ¨ Ù†Ø²ÙˆÙ„ÛŒ",
                        remove: "Ø­Ø°Ù� Ù…Ø±ØªØ¨ Ú©Ø±Ø¯Ù†"
                    },
                    column: {
                        hide: "Ù¾Ù†Ù‡Ø§Ù†â€ŒÚ©Ø±Ø¯Ù† Ø³ØªÙˆÙ†"
                    },
                    aggregation: {
                        count: "ØªØ¹Ø¯Ø§Ø¯: ",
                        sum: "Ù…Ø¬Ù…ÙˆØ¹: ",
                    ...
                    pinning: {
                        pinLeft: "Ù¾ÛŒÙ† Ú©Ø±Ø¯Ù† Ø³Ù…Øª Ú†Ù¾",
                        pinRight: "Ù¾ÛŒÙ† Ú©Ø±Ø¯Ù† Ø³Ù…Øª Ø±Ø§Ø³Øª",
                        unpin: "Ø­Ø°Ù� Ù¾ÛŒÙ†"
                    },
                    gridMenu: {
                        columns: "Ø³ØªÙˆÙ†â€ŒÙ‡Ø§:",
                        importerTitle: "ÙˆØ§Ø±Ø¯ Ú©Ø±Ø¯Ù† Ù�Ø§ÛŒÙ„",
                        exporterAllAsCsv: "Ø®Ø±ÙˆØ¬ÛŒ ØªÙ…Ø§Ù… Ø¯Ø§Ø¯Ù‡â€ŒÙ‡Ø§ Ø¯Ø± Ù�Ø§ÛŒÙ„ csv",
                        exporterVisibleAsCsv: "Ø®Ø±ÙˆØ¬ÛŒ Ø¯Ø§Ø¯Ù‡â€ŒÙ‡Ø§ÛŒ Ù‚Ø§Ø¨Ù„ Ù…Ø´Ø§Ù‡Ø¯Ù‡ Ø¯Ø± Ù�Ø§ÛŒÙ„ csv",
                        exporterSelectedAsCsv: "Ø®Ø±ÙˆØ¬ÛŒ Ø¯Ø§Ø¯Ù‡â€ŒÙ‡Ø§ÛŒ Ø§Ù†ØªØ®Ø§Ø¨â€ŒØ´Ø¯Ù‡ Ø¯Ø± Ù�Ø§ÛŒÙ„ csv"
                    },
                    importer: {
                        noHeaders: "Ù†Ø§Ù… Ø³ØªÙˆÙ† Ù‚Ø§Ø¨Ù„ Ø§Ø³ØªØ®Ø±Ø§Ø¬ Ù†ÛŒØ³Øª. Ø¢ÛŒØ§ Ù�Ø§ÛŒÙ„ Ø¹Ù†ÙˆØ§Ù† Ø¯Ø§Ø±Ø¯ØŸ",
                        noObjects: "Ø§Ø´ÛŒØ§ Ù‚Ø§Ø¨Ù„ Ø§Ø³ØªØ®Ø±Ø§Ø¬ Ù†ÛŒØ³ØªÙ†Ø¯. Ø¢ÛŒØ§ Ø¨Ù‡ Ø¬Ø² Ø¹Ù†ÙˆØ§Ù†â€ŒÙ‡Ø§ Ø¯Ø± Ù�Ø§ÛŒÙ„ Ø¯Ø§Ø¯Ù‡ ÙˆØ¬ÙˆØ¯ Ø¯Ø§Ø±Ø¯ØŸ",
                        invalidCsv: "Ù�Ø§ÛŒÙ„ Ù‚Ø§Ø¨Ù„ Ù¾Ø±Ø¯Ø§Ø²Ø´ Ù†ÛŒØ³Øª. Ø¢ÛŒØ§ Ù�Ø±Ù…Øª  csv  Ù…Ø¹ØªØ¨Ø± Ø§Ø³ØªØŸ",
                        invalidJson: "Ù�Ø§ÛŒÙ„ Ù‚Ø§Ø¨Ù„ Ù¾Ø±Ø¯Ø§Ø²Ø´ Ù†ÛŒØ³Øª. Ø¢ÛŒØ§ Ù�Ø±Ù…Øª json   Ù…Ø¹ØªØ¨Ø± Ø§Ø³ØªØŸ",
                        jsonNotArray: "Ù�Ø§ÛŒÙ„ json ÙˆØ§Ø±Ø¯ Ø´Ø¯Ù‡ Ø¨Ø§ÛŒØ¯ Ø­Ø§ÙˆÛŒ Ø¢Ø±Ø§ÛŒÙ‡ Ø¨Ø§Ø´Ø¯. Ø¹Ù…Ù„ÛŒØ§Øª Ø³Ø§Ù‚Ø· Ø´Ø¯."
                    },
                    pagination: {
                        sizes: "Ø§Ù‚Ù„Ø§Ù… Ø¯Ø± Ù‡Ø± ØµÙ�Ø­Ù‡",
                        totalItems: "Ø§Ù‚Ù„Ø§Ù…",
                        of: "Ø§Ø²"
                    },
                    grouping: {
                        group: "Ú¯Ø±ÙˆÙ‡â€ŒØ¨Ù†Ø¯ÛŒ",
                        ungroup: "Ø­Ø°Ù� Ú¯Ø±ÙˆÙ‡â€ŒØ¨Ù†Ø¯ÛŒ",
                        aggregate_count: "Agg: ØªØ¹Ø¯Ø§Ø¯",
                        aggregate_sum: "Agg: Ø¬Ù…Ø¹",
                        aggregate_max: "Agg: Ø¨ÛŒØ´ÛŒÙ†Ù‡",
                        aggregate_min: "Agg: Ú©Ù…ÛŒÙ†Ù‡",
                        aggregate_avg: "Agg: Ù…ÛŒØ§Ù†Ú¯ÛŒÙ†",
                        aggregate_remove: "Agg: Ø­Ø°Ù�"
                    }
                }), a
            }])
        }])
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("fi", {
                    ...
                    groupPanel: {
                        description: "Raahaa ja pudota otsikko tÃ¤hÃ¤n ryhmittÃ¤Ã¤ksesi sarakkeen mukaan."
                    },
                    search: {
                        placeholder: "Hae...",
                        showingItems: "NÃ¤ytetÃ¤Ã¤n rivejÃ¤:",
                        selectedItems: "Valitut rivit:",
                        totalItems: "RivejÃ¤ yht.:",
                        size: "NÃ¤ytÃ¤:",
                        first: "EnsimmÃ¤inen sivu",
                        next: "Seuraava sivu",
                    ...
                    sort: {
                        ascending: "JÃ¤rjestÃ¤ nouseva",
                        descending: "JÃ¤rjestÃ¤ laskeva",
                        remove: "Poista jÃ¤rjestys"
                    },
                    column: {
                        hide: "Piilota sarake"
                    },
                    ...
                    gridMenu: {
                        ...
                        exporterVisibleAsCsv: "Vie nÃ¤kyvÃ¤ tieto csv-muodossa",
                        exporterSelectedAsCsv: "Vie valittu tieto csv-muodossa"
                    },
                    importer: {
                        noHeaders: "Sarakkeen nimiÃ¤ ei voitu pÃ¤Ã¤tellÃ¤, onko tiedostossa otsikkoriviÃ¤?",
                        noObjects: "Tietoja ei voitu lukea, onko tiedostossa muuta kuin otsikkot?",
                        invalidCsv: "Tiedostoa ei voitu kÃ¤sitellÃ¤, oliko se CSV-muodossa?",
                        invalidJson: "Tiedostoa ei voitu kÃ¤sitellÃ¤, oliko se JSON-muodossa?",
                        jsonNotArray: "Tiedosto ei sisÃ¤ltÃ¤nyt taulukkoa, lopetetaan."
                    }
                }), a
            }])
        }])
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("fr", {
                    ...
                    groupPanel: {
                        description: "Faites glisser une en-tÃªte de colonne ici pour crÃ©er un groupe de colonnes."
                    },
                    search: {
                        placeholder: "Recherche...",
                        showingItems: "Affichage des Ã©lÃ©ments :",
                        selectedItems: "Ã‰lÃ©ments sÃ©lectionnÃ©s :",
                        totalItems: "Nombre total d'Ã©lÃ©ments:",
                        size: "Taille de page:",
                    ...
                    sort: {
                        ...
                        descending: "Trier par ordre dÃ©croissant",
                    ...
                    pinning: {
                        pinLeft: "Ã‰pingler Ã  gauche",
                        pinRight: "Ã‰pingler Ã  droite",
                        unpin: "DÃ©tacher"
                    },
                    gridMenu: {
                        columns: "Colonnes:",
                        importerTitle: "Importer un fichier",
                        exporterAllAsCsv: "Exporter toutes les donnÃ©es en CSV",
                        exporterVisibleAsCsv: "Exporter les donnÃ©es visibles en CSV",
                        exporterSelectedAsCsv: "Exporter les donnÃ©es sÃ©lectionnÃ©es en CSV"
                    },
                    importer: {
                        noHeaders: "Impossible de dÃ©terminer le nom des colonnes, le fichier possÃ¨de-t-il une en-tÃªte ?",
                        noObjects: "Aucun objet trouvÃ©, le fichier possÃ¨de-t-il des donnÃ©es autres que l'en-tÃªte ?",
                        invalidCsv: "Le fichier n'a pas pu Ãªtre traitÃ©, le CSV est-il valide ?",
                        invalidJson: "Le fichier n'a pas pu Ãªtre traitÃ©, le JSON est-il valide ?",
                        jsonNotArray: "Le fichier JSON importÃ© doit contenir un tableau, abandon."
                    },
                    pagination: {
                        sizes: "Ã©lÃ©ments par page",
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("hy", {
                    ...
                    groupPanel: {
                        description: "Ô¸Õ½Õ¿ Õ½ÕµÕ¡Õ¶ Õ­Õ´Õ¢Õ¡Õ¾Õ¸Ö€Õ¥Õ¬Õ¸Ö‚ Õ°Õ¡Õ´Õ¡Ö€ Ö„Õ¡Õ·Õ¥Ö„ Ö‡ Õ£Ö�Õ¥Ö„ Õ¾Õ¥Ö€Õ¶Õ¡Õ£Õ«Ö€Õ¶ Õ¡ÕµÕ½Õ¿Õ¥Õ²Ö‰"
                    },
                    search: {
                        placeholder: "Õ“Õ¶Õ¿Ö€Õ¸Ö‚Õ´...",
                        showingItems: "Õ‘Õ¸Ö‚Ö�Õ¡Õ¤Ö€Õ¾Õ¡Õ® Õ¿Õ¾ÕµÕ¡Õ¬Õ¶Õ¥Ö€Õ�",
                        selectedItems: "Ô¸Õ¶Õ¿Ö€Õ¾Õ¡Õ®:",
                        totalItems: "Ô¸Õ¶Õ¤Õ¡Õ´Õ¥Õ¶Õ¨Õ�",
                        size: "Õ�Õ¸Õ²Õ¥Ö€Õ« Ö„Õ¡Õ¶Õ¡Õ¯Õ¨ Õ§Õ»Õ¸Ö‚Õ´Õ�",
                    ...
                    column: {
                        hide: "Ô¹Õ¡Ö„Ö�Õ¶Õ¥Õ¬ Õ½ÕµÕ¸Ö‚Õ¶Õ¨"
                    },
                    aggregation: {
                    ...
                    pinning: {
                        pinLeft: "Ô¿ÕºÖ�Õ¶Õ¥Õ¬ Õ±Õ¡Õ­ Õ¯Õ¸Õ²Õ´Õ¸Ö‚Õ´",
                        pinRight: "Ô¿ÕºÖ�Õ¶Õ¥Õ¬ Õ¡Õ» Õ¯Õ¸Õ²Õ´Õ¸Ö‚Õ´",
                        unpin: "Ô±Ö€Õ±Õ¡Õ¯Õ¥Õ¬"
                    },
                    gridMenu: {
                        columns: "Õ�ÕµÕ¸Ö‚Õ¶Õ¥Ö€:",
                        importerTitle: "Õ†Õ¥Ö€Õ´Õ¸Ö‚Õ®Õ¥Õ¬ Ö†Õ¡ÕµÕ¬",
                        exporterAllAsCsv: "Ô±Ö€Õ¿Õ¡Õ°Õ¡Õ¶Õ¥Õ¬ Õ¡Õ´Õ¢Õ¸Õ²Õ»Õ¨ CSV",
                        exporterVisibleAsCsv: "Ô±Ö€Õ¿Õ¡Õ°Õ¡Õ¶Õ¥Õ¬ Õ¥Ö€Ö‡Õ¡Ö�Õ¸Õ² Õ¿Õ¾ÕµÕ¡Õ¬Õ¶Õ¥Ö€Õ¨ CSV",
                    ...
                    importer: {
                        ...
                        jsonNotArray: "Õ†Õ¥Ö€Õ´Õ¸Ö‚Õ®Õ¾Õ¡Õ® json Ö†Õ¡ÕµÕ¬Õ¨ ÕºÕ¥Õ¿Ö„ Õ§ ÕºÕ¡Ö€Õ¸Ö‚Õ¶Õ¡Õ¯Õ« Õ¦Õ¡Õ¶Õ£Õ¾Õ¡Õ®, Õ¯Õ¡Õ½Õ¥Ö�Õ¾Õ¸Ö‚Õ´ Õ§Ö‰"
                    }
                }), a
            }])
        }])
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("ja", {
                    ...
                    groupPanel: {
                        description: "ã�“ã�“ã�«åˆ—ãƒ˜ãƒƒãƒ€ã‚’ãƒ‰ãƒ©ãƒƒã‚°ã‚¢ãƒ³ãƒ‰ãƒ‰ãƒ­ãƒƒãƒ—ã�—ã�¦ã€�ã��ã�®åˆ—ã�§ã‚°ãƒ«ãƒ¼ãƒ—åŒ–ã�—ã�¾ã�™ã€‚"
                    },
                    search: {
                        placeholder: "æ¤œç´¢...",
                        showingItems: "è¡¨ç¤ºä¸­ã�®é …ç›®:",
                        selectedItems: "é�¸æŠžã�—ã�Ÿé …ç›®:",
                        totalItems: "é …ç›®ã�®ç·�æ•°:",
                        size: "ãƒšãƒ¼ã‚¸ã‚µã‚¤ã‚º:",
                        first: "æœ€åˆ�ã�®ãƒšãƒ¼ã‚¸",
                        next: "æ¬¡ã�®ãƒšãƒ¼ã‚¸",
                    ...
                    sort: {
                        ascending: "æ˜‡é †ã�«ä¸¦ã�¹æ›¿ã�ˆ",
                        descending: "é™�é †ã�«ä¸¦ã�¹æ›¿ã�ˆ",
                        remove: "ä¸¦ã�¹æ›¿ã�ˆã�®è§£é™¤"
                    },
                    column: {
                        hide: "åˆ—ã�®é�žè¡¨ç¤º"
                    },
                    ...
                    gridMenu: {
                        columns: "åˆ—:",
                        importerTitle: "ãƒ•ã‚¡ã‚¤ãƒ«ã�®ã‚¤ãƒ³ãƒ�ãƒ¼ãƒˆ",
                        exporterAllAsCsv: "ã�™ã�¹ã�¦ã�®ãƒ‡ãƒ¼ã‚¿ã‚’CSVå½¢å¼�ã�§ã‚¨ã‚¯ã‚¹ãƒ�ãƒ¼ãƒˆ",
                        exporterVisibleAsCsv: "è¡¨ç¤ºä¸­ã�®ãƒ‡ãƒ¼ã‚¿ã‚’CSVå½¢å¼�ã�§ã‚¨ã‚¯ã‚¹ãƒ�ãƒ¼ãƒˆ",
                        exporterSelectedAsCsv: "é�¸æŠžã�—ã�Ÿãƒ‡ãƒ¼ã‚¿ã‚’CSVå½¢å¼�ã�§ã‚¨ã‚¯ã‚¹ãƒ�ãƒ¼ãƒˆ"
                    },
                    importer: {
                        noHeaders: "åˆ—å��ã‚’å�–å¾—ã�§ã��ã�¾ã�›ã‚“ã€‚ãƒ•ã‚¡ã‚¤ãƒ«ã�«ãƒ˜ãƒƒãƒ€ã�Œå�«ã�¾ã‚Œã�¦ã�„ã‚‹ã�“ã�¨ã‚’ç¢ºèª�ã�—ã�¦ã��ã� ã�•ã�„ã€‚",
                        noObjects: "ã‚ªãƒ–ã‚¸ã‚§ã‚¯ãƒˆã‚’å�–å¾—ã�§ã��ã�¾ã�›ã‚“ã€‚ãƒ•ã‚¡ã‚¤ãƒ«ã�«ãƒ˜ãƒƒãƒ€ä»¥å¤–ã�®ãƒ‡ãƒ¼ã‚¿ã�Œå�«ã�¾ã‚Œã�¦ã�„ã‚‹ã�“ã�¨ã‚’ç¢ºèª�ã�—ã�¦ã��ã� ã�•ã�„ã€‚",
                        invalidCsv: "ãƒ•ã‚¡ã‚¤ãƒ«ã‚’å‡¦ç�†ã�§ã��ã�¾ã�›ã‚“ã€‚ãƒ•ã‚¡ã‚¤ãƒ«ã�Œæœ‰åŠ¹ã�ªCSVå½¢å¼�ã�§ã�‚ã‚‹ã�“ã�¨ã‚’ç¢ºèª�ã�—ã�¦ã��ã� ã�•ã�„ã€‚",
                        invalidJson: "ãƒ•ã‚¡ã‚¤ãƒ«ã‚’å‡¦ç�†ã�§ã��ã�¾ã�›ã‚“ã€‚ãƒ•ã‚¡ã‚¤ãƒ«ã�Œæœ‰åŠ¹ã�ªJSONå½¢å¼�ã�§ã�‚ã‚‹ã�“ã�¨ã‚’ç¢ºèª�ã�—ã�¦ã��ã� ã�•ã�„ã€‚",
                        jsonNotArray: "ã‚¤ãƒ³ãƒ�ãƒ¼ãƒˆã�—ã�ŸJSONãƒ•ã‚¡ã‚¤ãƒ«ã�«ã�¯é…�åˆ—ã�Œå�«ã�¾ã‚Œã�¦ã�„ã‚‹å¿…è¦�ã�Œã�‚ã‚Šã�¾ã�™ã€‚å‡¦ç�†ã‚’ä¸­æ­¢ã�—ã�¾ã�™ã€‚"
                    },
                    pagination: {
                        sizes: "é …ç›®/ãƒšãƒ¼ã‚¸",
                        totalItems: "é …ç›®"
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("ko", {
                    ...
                    groupPanel: {
                        description: "ì»¬ëŸ¼ìœ¼ë¡œ ê·¸ë£¹í•‘í•˜ê¸° ìœ„í•´ì„œëŠ” ì»¬ëŸ¼ í—¤ë�”ë¥¼ ë�Œì–´ ë–¨ì–´ëœ¨ë ¤ ì£¼ì„¸ìš”."
                    },
                    search: {
                        placeholder: "ê²€ìƒ‰...",
                        showingItems: "í•­ëª© ë³´ì—¬ì£¼ê¸°:",
                    ...
                    gridMenu: {
                        ...
                        exporterAllAsCsv: "csvë¡œ ëª¨ë“  ë�°ì�´í„° ë‚´ë³´ë‚´ê¸°",
                        exporterVisibleAsCsv: "csvë¡œ ë³´ì�´ëŠ” ë�°ì�´í„° ë‚´ë³´ë‚´ê¸°",
                        exporterSelectedAsCsv: "csvë¡œ ì„ íƒ�ë�œ ë�°ì�´í„° ë‚´ë³´ë‚´ê¸°"
                    },
                    importer: {
                        noHeaders: "ì»¬ëŸ¼ëª…ì�´ ì§€ì •ë�˜ì–´ ìžˆì§€ ì•ŠìŠµë‹ˆë‹¤. íŒŒì�¼ì—� í—¤ë�”ê°€ ëª…ì‹œë�˜ì–´ ìžˆëŠ”ì§€ í™•ì�¸í•´ ì£¼ì„¸ìš”.",
                        noObjects: "ë�°ì�´í„°ê°€ ì§€ì •ë�˜ì–´ ìžˆì§€ ì•ŠìŠµë‹ˆë‹¤. ë�°ì�´í„°ê°€ íŒŒì�¼ì—� ìžˆëŠ”ì§€ í™•ì�¸í•´ ì£¼ì„¸ìš”.",
                        invalidCsv: "íŒŒì�¼ì�„ ì²˜ë¦¬í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤. ì˜¬ë°”ë¥¸ csvì�¸ì§€ í™•ì�¸í•´ ì£¼ì„¸ìš”.",
                        invalidJson: "íŒŒì�¼ì�„ ì²˜ë¦¬í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤. ì˜¬ë°”ë¥¸ jsonì�¸ì§€ í™•ì�¸í•´ ì£¼ì„¸ìš”.",
                        jsonNotArray: "json íŒŒì�¼ì�€ ë°°ì—´ì�„ í�¬í•¨í•´ì•¼ í•©ë‹ˆë‹¤."
                    },
                    pagination: {
                        sizes: "íŽ˜ì�´ì§€ë‹¹ í•­ëª©",
                        totalItems: "ì „ì²´ í•­ëª©"
            ...
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("pt-br", {
                    ...
                    gridMenu: {
                        ...
                        exporterVisibleAsCsv: "Exportar dados visÃ­veis como csv",
                        exporterSelectedAsCsv: "Exportar dados selecionados como csv"
                    },
                    importer: {
                        noHeaders: "Nomes de colunas nÃ£o puderam ser derivados. O arquivo tem um cabeÃ§alho?",
                        noObjects: "Objetos nÃ£o puderam ser derivados. Havia dados no arquivo, alÃ©m dos cabeÃ§alhos?",
                        invalidCsv: "Arquivo nÃ£o pode ser processado. Ã‰ um CSV vÃ¡lido?",
                        invalidJson: "Arquivo nÃ£o pode ser processado. Ã‰ um Json vÃ¡lido?",
                        jsonNotArray: "Arquivo json importado tem que conter um array. Abortando."
                    },
                    pagination: {
                        sizes: "itens por pÃ¡gina",
                        totalItems: "itens"
                    },
                    grouping: {
                        group: "Agrupar",
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("pt", {
                    ...
                    importer: {
                        noHeaders: "Nomes de colunas nÃ£o puderam ser derivados. O ficheiro tem um cabeÃ§alho?",
                        noObjects: "Objetos nÃ£o puderam ser derivados. Havia dados no ficheiro, alÃ©m dos cabeÃ§alhos?",
                        invalidCsv: "Ficheiro nÃ£o pode ser processado. Ã‰ um CSV vÃ¡lido?",
                        invalidJson: "Ficheiro nÃ£o pode ser processado. Ã‰ um Json vÃ¡lido?",
    ...
    function() {
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("ru", {
                    aggregate: {
                        label: "Ñ�Ð»ÐµÐ¼ÐµÐ½Ñ‚Ñ‹"
                    },
                    groupPanel: {
                        description: "Ð”Ð»Ñ� Ð³Ñ€ÑƒÐ¿Ð¿Ð¸Ñ€Ð¾Ð²ÐºÐ¸ Ð¿Ð¾ Ñ�Ñ‚Ð¾Ð»Ð±Ñ†Ñƒ Ð¿ÐµÑ€ÐµÑ‚Ð°Ñ‰Ð¸Ñ‚Ðµ Ñ�ÑŽÐ´Ð° ÐµÐ³Ð¾ Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ðµ."
                    },
                    search: {
                        placeholder: "ÐŸÐ¾Ð¸Ñ�Ðº...",
                        showingItems: "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ñ�Ð»ÐµÐ¼ÐµÐ½Ñ‚Ñ‹:",
                        selectedItems: "Ð’Ñ‹Ð±Ñ€Ð°Ð½Ð½Ñ‹Ðµ Ñ�Ð»ÐµÐ¼ÐµÐ½Ñ‚Ñ‹:",
                        totalItems: "Ð’Ñ�ÐµÐ³Ð¾ Ñ�Ð»ÐµÐ¼ÐµÐ½Ñ‚Ð¾Ð²:",
                        size: "Ð Ð°Ð·Ð¼ÐµÑ€ Ñ�Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹:",
                        first: "ÐŸÐµÑ€Ð²Ð°Ñ� Ñ�Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°",
                        next: "Ð¡Ð»ÐµÐ´ÑƒÑŽÑ‰Ð°Ñ� Ñ�Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°",
                        previous: "ÐŸÑ€ÐµÐ´Ñ‹Ð´ÑƒÑ‰Ð°Ñ� Ñ�Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°",
                        last: "ÐŸÐ¾Ñ�Ð»ÐµÐ´Ð½Ñ�Ñ� Ñ�Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°"
                    },
                    menu: {
                        text: "Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ñ�Ñ‚Ð¾Ð»Ð±Ñ†Ñ‹:"
                    },
                    sort: {
                        ascending: "ÐŸÐ¾ Ð²Ð¾Ð·Ñ€Ð°Ñ�Ñ‚Ð°Ð½Ð¸ÑŽ",
                        descending: "ÐŸÐ¾ ÑƒÐ±Ñ‹Ð²Ð°Ð½Ð¸ÑŽ",
                        remove: "Ð£Ð±Ñ€Ð°Ñ‚ÑŒ Ñ�Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²ÐºÑƒ"
                    },
                    column: {
                        hide: "Ñ�Ð¿Ñ€Ñ�Ñ‚Ð°Ñ‚ÑŒ Ñ�Ñ‚Ð¾Ð»Ð±ÐµÑ†"
                    },
                    aggregation: {
                        count: "Ð²Ñ�ÐµÐ³Ð¾ Ñ�Ñ‚Ñ€Ð¾Ðº: ",
                        sum: "Ð¸Ñ‚Ð¾Ð³Ð¾: ",
                        avg: "Ñ�Ñ€ÐµÐ´Ð½ÐµÐµ: ",
                        min: "Ð¼Ð¸Ð½: ",
                        max: "Ð¼Ð°ÐºÑ�: "
                    ...
                    gridMenu: {
                        ...
                        importerTitle: "Import file",
                        exporterAllAsCsv: "Ð­ÐºÑ�Ð¿Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð²Ñ�Ñ‘ Ð² CSV",
                        exporterVisibleAsCsv: "Ð­ÐºÑ�Ð¿Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð²Ð¸Ð´Ð¸Ð¼Ñ‹Ðµ Ð´Ð°Ð½Ð½Ñ‹Ðµ Ð² CSV",
                        exporterSelectedAsCsv: "Ð­ÐºÑ�Ð¿Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ñ‹Ðµ Ð´Ð°Ð½Ð½Ñ‹Ðµ Ð² CSV"
                    },
                    importer: {
                        noHeaders: "Column names were unable to be derived, does the file have a header?",
                        noObjects: "Objects were not able to be derived, was there data in the file other than headers?",
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("sk", {
                    ...
                    groupPanel: {
                        description: "Pretiahni sem nÃ¡zov stÄºpca pre zoskupenie podÄ¾a toho stÄºpca."
                    },
                    search: {
                        placeholder: "HÄ¾adaj...",
                        showingItems: "Zobrazujem poloÅ¾ky:",
                        selectedItems: "VybratÃ© poloÅ¾ky:",
                        totalItems: "PoÄ�et poloÅ¾iek:",
                        size: "PoÄ�et:",
                        first: "PrvÃ¡ strana",
                        next: "ÄŽalÅ¡ia strana",
                        previous: "PredchÃ¡dzajÃºca strana",
                        last: "PoslednÃ¡ strana"
                    },
                    menu: {
                        text: "Vyberte stÄºpce:"
                    },
                    sort: {
                        ascending: "ZotriediÅ¥ vzostupne",
                        descending: "ZotriediÅ¥ zostupne",
                        remove: "VymazaÅ¥ triedenie"
                    },
                    aggregation: {
                        count: "total rows: ",
                        sum: "total: ",
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("sv", {
                    ...
                    groupPanel: {
                        description: "Dra en kolumnrubrik hit och slÃ¤pp den fÃ¶r att gruppera efter den kolumnen."
                    },
                    search: {
                        placeholder: "SÃ¶k...",
                    ...
                    pinning: {
                        pinLeft: "FÃ¤st vÃ¤nster",
                        pinRight: "FÃ¤st hÃ¶ger",
                        unpin: "LÃ¶sgÃ¶r"
                    },
                    gridMenu: {
                        columns: "Kolumner:",
                    ...
                    importer: {
                        noHeaders: "Kolumnnamn kunde inte hÃ¤rledas. Har filen ett sidhuvud?",
                        noObjects: "Objekt kunde inte hÃ¤rledas. Har filen data undantaget sidhuvud?",
                        invalidCsv: "Filen kunde inte behandlas, Ã¤r den en giltig CSV?",
                        invalidJson: "Filen kunde inte behandlas, Ã¤r den en giltig JSON?",
                        jsonNotArray: "Importerad JSON-fil mÃ¥ste innehÃ¥lla ett fÃ¤lt. Import avbruten."
                    },
                    pagination: {
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("zh-cn", {
                    ...
                    groupPanel: {
                        description: "æ‹–æ›³è¡¨å¤´åˆ°æ­¤å¤„è¿›è¡Œåˆ†ç»„"
                    },
                    search: {
                        placeholder: "æŸ¥æ‰¾",
                        showingItems: "å·²æ˜¾ç¤ºè¡Œæ•°ï¼š",
                        selectedItems: "å·²é€‰æ‹©è¡Œæ•°ï¼š",
                        totalItems: "æ€»è¡Œæ•°ï¼š",
                    ...
                    gridMenu: {
                        columns: "åˆ—ï¼š",
                        importerTitle: "å¯¼å…¥æ–‡ä»¶",
                        exporterAllAsCsv: "å¯¼å‡ºå…¨éƒ¨æ•°æ�®åˆ°CSV",
                        exporterVisibleAsCsv: "å¯¼å‡ºå�¯è§�æ•°æ�®åˆ°CSV",
                        exporterSelectedAsCsv: "å¯¼å‡ºå·²é€‰æ•°æ�®åˆ°CSV"
                    },
                    importer: {
                        noHeaders: "æ— æ³•èŽ·å�–åˆ—å��ï¼Œç¡®å®šæ–‡ä»¶åŒ…å�«è¡¨å¤´ï¼Ÿ",
                        noObjects: "æ— æ³•èŽ·å�–æ•°æ�®ï¼Œç¡®å®šæ–‡ä»¶åŒ…å�«æ•°æ�®ï¼Ÿ",
                        invalidCsv: "æ— æ³•å¤„ç�†æ–‡ä»¶ï¼Œç¡®å®šæ˜¯å�ˆæ³•çš„CSVæ–‡ä»¶ï¼Ÿ",
                        invalidJson: "æ— æ³•å¤„ç�†æ–‡ä»¶ï¼Œç¡®å®šæ˜¯å�ˆæ³•çš„JSONæ–‡ä»¶ï¼Ÿ",
                        jsonNotArray: "å¯¼å…¥çš„æ–‡ä»¶ä¸�æ˜¯JSONæ•°ç»„ï¼�"
                    },
                    pagination: {
                        sizes: "è¡Œæ¯�é¡µ",
                        totalItems: "è¡Œ"
        ...
        angular.module("ui.grid").config(["$provide", function(a) {
            a.decorator("i18nService", ["$delegate", function(a) {
                return a.add("zh-tw", {
                    ...
                    groupPanel: {
                        description: "æ‹–æ›³è¡¨é ­åˆ°æ­¤è™•é€²è¡Œåˆ†çµ„"
                    },
                    search: {
                        placeholder: "æŸ¥æ‰¾",
                        showingItems: "å·²é¡¯ç¤ºè¡Œæ•¸ï¼š",
                        selectedItems: "å·²é�¸æ“‡è¡Œæ•¸ï¼š",
                        totalItems: "ç¸½è¡Œæ•¸ï¼š",
                    ...
                    gridMenu: {
                        columns: "åˆ—ï¼š",
                        importerTitle: "å°Žå…¥æ–‡ä»¶",
                        exporterAllAsCsv: "å°Žå‡ºå…¨éƒ¨æ•¸æ“šåˆ°CSV",
                        exporterVisibleAsCsv: "å°Žå‡ºå�¯è¦‹æ•¸æ“šåˆ°CSV",
                        exporterSelectedAsCsv: "å°Žå‡ºå·²é�¸æ•¸æ“šåˆ°CSV"
                    },
                    importer: {
                        noHeaders: "ç„¡æ³•ç�²å�–åˆ—å��ï¼Œç¢ºå®šæ–‡ä»¶åŒ…å�«è¡¨é ­ï¼Ÿ",
                        noObjects: "ç„¡æ³•ç�²å�–æ•¸æ“šï¼Œç¢ºå®šæ–‡ä»¶åŒ…å�«æ•¸æ“šï¼Ÿ",
                        invalidCsv: "ç„¡æ³•è™•ç�†æ–‡ä»¶ï¼Œç¢ºå®šæ˜¯å�ˆæ³•çš„CSVæ–‡ä»¶ï¼Ÿ",
                        invalidJson: "ç„¡æ³•è™•ç�†æ–‡ä»¶ï¼Œç¢ºå®šæ˜¯å�ˆæ³•çš„JSONæ–‡ä»¶ï¼Ÿ",
                        jsonNotArray: "å°Žå…¥çš„æ–‡ä»¶ä¸�æ˜¯JSONæ•¸çµ„ï¼�"
                    },
                    pagination: {
                        sizes: "è¡Œæ¯�é �",
                        totalItems: "è¡Œ"
    ...
    function() {
        ...
        b.constant("uiGridCellNavConstants", {
        ...
        }), b.factory("uiGridCellNavFactory", ["gridUtil", "uiGridConstants", "uiGridCellNavConstants", "$q", function(b, c, d, e) {
            ...
            return f.prototype.getFocusableCols = function() {
            ...
            }, f.prototype.getNextRowCol = function(a, b, c) {
                switch (a) {
                ...
                var b = this.getFocusableCols(),
                    c = this.getFocusableRows();
                if (0 === b.length || 0 === c.length) return null;
                return new a(c[0], b[0])
            }, f.prototype.getRowColLeft = function(b, c) {
                var d = this.getFocusableCols(),
                    e = this.getFocusableRows(),
                    f = d.indexOf(c),
                    g = e.indexOf(b); - 1 === f && (f = 1);
                var h = 0 === f ? d.length - 1 : f - 1;
                return h > f ? 0 === g ? new a(b, d[h]) : new a(e[g - 1], d[h]) : new a(b, d[h])
            }, f.prototype.getRowColRight = function(b, c) {
                var d = this.getFocusableCols(),
                    e = this.getFocusableRows(),
                    f = d.indexOf(c),
                    g = e.indexOf(b); - 1 === f && (f = 0);
                var h = f === d.length - 1 ? 0 : f + 1;
                return f > h ? g === e.length - 1 ? new a(b, d[h]) : new a(e[g + 1], d[h]) : new a(b, d[h])
            }, f.prototype.getRowColDown = function(b, c) {
                var d = this.getFocusableCols(),
                    e = this.getFocusableRows(),
                    f = d.indexOf(c),
                    g = e.indexOf(b);
                return -1 === f && (f = 0), g === e.length - 1 ? new a(b, d[f]) : new a(e[g + 1], d[f])
            }, f.prototype.getRowColPageDown = function(b, c) {
                var d = this.getFocusableCols(),
                    e = this.getFocusableRows(),
                    f = d.indexOf(c),
                    g = e.indexOf(b); - 1 === f && (f = 0);
            ...
            }, f.prototype.getRowColUp = function(b, c) {
                var d = this.getFocusableCols(),
                    e = this.getFocusableRows(),
                    f = d.indexOf(c),
                    g = e.indexOf(b);
                return -1 === f && (f = 0), 0 === g ? new a(b, d[f]) : new a(e[g - 1], d[f])
            }, f.prototype.getRowColPageUp = function(b, c) {
                var d = this.getFocusableCols(),
                    e = this.getFocusableRows(),
                    f = d.indexOf(c),
                    g = e.indexOf(b); - 1 === f && (f = 0);
            ...
            return g
        }]), b.directive("uiGridCellnav", ["gridUtil", "uiGridCellNavService", "uiGridCellNavConstants", "uiGridConstants", "$timeout", function(b, c, d, e, f) {
            return {
                replace: !0,
                priority: -150,
                require: "^uiGrid",
                ...
                compile: function() {
                    return {
                        pre: function(b, f, g, h) {
                            var i = b,
                                j = h.grid;
                            c.initializeGrid(j), h.cellNav = {}, h.cellNav.getActiveCell = function() {
                                ...
                                i.$broadcast(d.CELL_NAV_EVENT, {
                                    eventType: d.EVENT_TYPE.CLEAR
                                })
                            }, h.cellNav.broadcastFocus = function(b, c) {
                                c = !(void 0 === c || !c);
                                var d = b.row,
                                    e = b.col,
                                    f = h.grid.api.cellNav.rowColSelectIndex(b);
                                ...
                                if (g) {
                                    ...
                                    return b === d.direction.LEFT && i.col === k[k.length - 1] && i.row === g.row && a.keyCode === e.keymap.TAB && a.shiftKey ? (j.cellNav.focusedCells.splice(l, 1), h.cellNav.clearFocus(), !0) : b !== d.direction.RIGHT || i.col !== k[0] || i.row !== g.row || a.keyCode !== e.keymap.TAB || a.shiftKey ? (j.scrollToIfNecessary(i.row, i.col).then(function() {
        ...
        }]), b.directive("uiGridRenderContainer", ["$timeout", "$document", "gridUtil", "uiGridConstants", "uiGridCellNavService", "$compile", "uiGridCellNavConstants", function(a, b, c, d, e, f, g) {
            return {
                replace: !0,
                priority: -99999,
                ...
                compile: function() {
                    return {
                        post: function(b, c, d, h) {
                            var i = h[0],
                                j = h[1];
                            if (i.grid.api.cellNav) {
                                var k = j.containerId,
                                    l = i.grid;
                                if ("body" === k) {
                                    e.decorateRenderContainers(l);
                                    var m = f('<div class="ui-grid-focuser" tabindex="0"></div>')(b);
                                    c.append(m), i.focus = function() {
                                        m[0].focus(), m.on("focus", function(a) {
                                            a.uiGridTargetRenderContainerId = k;
                                            var b = i.grid.api.cellNav.getFocusedCell();
                                            null === b && (b = i.grid.renderContainers[k].cellNav.getNextRowCol(g.direction.DOWN, null, null), b.row && b.col && i.cellNav.broadcastCellNav(b))
                                        })
                                    };
                                    var n = null;
                                    m.on("keydown", function(a) {
                                        a.uiGridTargetRenderContainerId = k;
                                        var b = i.grid.api.cellNav.getFocusedCell(),
                                            c = i.cellNav.handleKeyDown(a);
                                        null === c && (i.grid.api.cellNav.raise.viewPortKeyDown(a, b), n = b)
                                    }), m.on("keypress", function(b) {
                                        n && (a(function() {
                                            i.grid.api.cellNav.raise.viewPortKeyPress(b, n)
                                        }, 4), n = null)
                                    })
                                }
                            }
        ...
        }]), b.directive("uiGridViewport", ["$timeout", "$document", "gridUtil", "uiGridConstants", "uiGridCellNavService", "uiGridCellNavConstants", "$log", "$compile", function(a, b, c, d, e, f, g, h) {
            return {
                replace: !0,
                priority: -99999,
                require: ["^uiGrid", "^uiGridRenderContainer", "?^uiGridCellnav"],
                    ...
                    return {
                        ...
                        post: function(a, b, c, d) {
                            ...
                            if (e.grid.api.cellNav) {
                                ...
                                if ("body" === g) {
                                    var h = e.grid;
                                    e.focus(), h.api.core.on.scrollBegin(a, function(a) {
                                        var c = e.grid.api.cellNav.getFocusedCell();
                                        if (null != c && f.colContainer.containsColumn(c.col)) {
                                            var d = b[0].getElementsByClassName("ui-grid-cell-focus");
                                            Array.prototype.forEach.call(d, function(a) {
                                                angular.element(a).removeClass("ui-grid-cell-focus")
                                            })
                                        }
        ...
        }]), b.directive("uiGridCell", ["$timeout", "$document", "uiGridCellNavService", "gridUtil", "uiGridCellNavConstants", "uiGridConstants", function(b, c, d, e, f, g) {
            return {
                priority: -150,
                restrict: "A",
                require: "^uiGrid",
                ...
                link: function(b, c, d, e) {
                    ...
                    e.grid.api.cellNav && b.col.colDef.allowCellFocus && (c.find("div").on("click", function(c) {
                        e.cellNav.broadcastCellNav(new a(b.row, b.col), c.ctrlKey || c.metaKey), c.stopPropagation(), b.$apply()
                    }), c.find("div").on("focus", function(c) {
                        e.cellNav.broadcastCellNav(new a(b.row, b.col), c.ctrlKey || c.metaKey)
                    }), b.$on(f.CELL_NAV_EVENT, function(a, c, d) {
                        return a.eventType === f.EVENT_TYPE.CLEAR ? void h() : void(c.row === b.row && c.col === b.col ? e.grid.options.modifierKeysToMultiSelectCells && d && -1 === e.grid.api.cellNav.rowColSelectIndex(c) ? h() : g() : e.grid.options.modifierKeysToMultiSelectCells && d || h())
                    }), b.$on("$destroy", function() {
                    ...
                    function u(c) {
                        if (!D && s(b.col, b.row)) {
                            ...
                            var n = b.col.grid.api.core.on.scrollBegin(b, function() {
                                    v(), b.grid.api.edit.raise.afterCellEdit(b.row.entity, b.col.colDef, A(b), z), n(), o(), p()
                                }),
        ...
        a.service("uiGridExpandableService", ["gridUtil", "$compile", function(a, b) {
            var c = {
                initializeGrid: function(b) {
                    b.expandable = {}, b.expandable.expandedAll = !1, b.options.enableExpandable = b.options.enableExpandable !== !1, b.options.expandableRowHeight = b.options.expandableRowHeight || 150, b.options.expandableRowHeaderWidth = b.options.expandableRowHeaderWidth || 40,
                        ...
                        a.service("uiGridPaginationService", ["gridUtil", function(a) {
                            ...
                            return {
                                ...
                                link: function(e, f, g, h) {
                                    e.paginationApi = h.grid.api.pagination, e.sizesLabel = d.getSafeText("pagination.sizes"), e.totalItemsLabel = d.getSafeText("pagination.totalItems"), e.paginationOf = d.getSafeText("pagination.of");
                                    ...
                                    var k = function() {
                                        ...
                                        l = e.$watch("grid.options.totalItems + grid.options.paginationPageSize", k),
                                        m = e.$watch("grid.options.paginationCurrentPage + grid.options.paginationPageSize", function(b, c) {
                                            if (b !== c) {
